...
User-friendly tools such as Kepler or VisTrails help document provenance, and Morpho provides an easy way to create standardized, machine-readable metadata using the [Ecological Metadata Language](https://eml.ecoinformatics.org/) (EML).
